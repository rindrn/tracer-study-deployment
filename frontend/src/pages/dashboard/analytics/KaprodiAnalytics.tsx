...
import { useKaprodiAnalytics } from "@/hooks/dashboard/kaprodi";

const KaprodiAnalyticsPage = () => {
  const { description } = useKaprodiAnalytics();
    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-muted-foreground mb-4">Segmentasi alumni prodi berdasarkan karakteristik karir</p>
...
export default KaprodiAnalyticsPage;
